...
const mRootmd5 = crypto
  .createHash('md5')
  .update(Buffer.concat([bLeftmd5, bRightmd5]))
  .digest();

describe('Test basic functions', () => {
  describe('make tree with no leaves', () => {
    const merkleTools = new MerkleTools();
    merkleTools.makeTree();

    it('merkle root value should be null', () => {
      assert.equal(merkleTools.getMerkleRoot(), null);
    });
  });

  describe('make tree with addLeaves hex', () => {
    const merkleTools = new MerkleTools();
    ...
    it('merkle root value should be correct', () => {
      const merkleRoot = merkleTools.getMerkleRoot();
      assert.notEqual(merkleRoot, null);
      if (merkleRoot !== null) {
        assert.equal(merkleRoot.toString('hex'), mRoot.toString('hex'));
      }
    });
  });

  describe('make tree with addLeaves buffers', () => {
    const merkleTools = new MerkleTools();
    merkleTools.addLeaves([bLeft, bRight]);
    merkleTools.makeTree();
  ...
  describe('getLeaf after running makeTree', () => {
    const merkleTools = new MerkleTools();
    merkleTools.addLeaves([
      'a292780cc748697cb499fdcc8cb89d835609f11e502281dfe3f6690b1cc23dcb',
      'cb4990b9a8936bbc137ddeb6dcab4620897b099a450ecdc5f3e86ef4b3a7135c'
    ...
    it('returned leaf should be in right spot', () => {
      const merkleLeaf = merkleTools.getLeaf(0);
      assert.notEqual(merkleLeaf, null);
      if (merkleLeaf !== null) {
        assert.equal(
          merkleLeaf.toString('hex'),
          'a292780cc748697cb499fdcc8cb89d835609f11e502281dfe3f6690b1cc23dcb'
        );
      }
    });
  ...
  describe('getLeaf out of bounds returns null after running makeTree', () => {
    const merkleTools = new MerkleTools();
    merkleTools.addLeaves([
      'a292780cc748697cb499fdcc8cb89d835609f11e502281dfe3f6690b1cc23dcb',
      'cb4990b9a8936bbc137ddeb6dcab4620897b099a450ecdc5f3e86ef4b3a7135c'
    ...
    it('out of bounds leaf position returns null', () => {
      assert.equal(merkleTools.getLeaf(3), null);
      assert.equal(merkleTools.getLeaf(-1), null);
    });
  });

  describe('getLeaf before running makeTree', () => {
    const merkleTools = new MerkleTools();
    merkleTools.addLeaves([
      'a292780cc748697cb499fdcc8cb89d835609f11e502281dfe3f6690b1cc23dcb',
      'cb4990b9a8936bbc137ddeb6dcab4620897b099a450ecdc5f3e86ef4b3a7135c'
  ...
  describe('getLeaf out of bounds returns null before running makeTree', () => {
    const merkleTools = new MerkleTools();
    merkleTools.addLeaves([
      'a292780cc748697cb499fdcc8cb89d835609f11e502281dfe3f6690b1cc23dcb',
      'cb4990b9a8936bbc137ddeb6dcab4620897b099a450ecdc5f3e86ef4b3a7135c'
  ...
  describe('make tree with addLeaf hex', () => {
    const merkleTools = new MerkleTools();
    merkleTools.addLeaf(
      'a292780cc748697cb499fdcc8cb89d835609f11e502281dfe3f6690b1cc23dcb'
    );
  ...
  describe('make tree with addLeaves hex', () => {
    ...
    merkleTools.makeTree();
    const targetProof0 = merkleTools.getProof(0);
    const targetProof1 = merkleTools.getProof(1);
    ...
    it('merkle root value should be correct', () => {
      ...
      assert.notEqual(targetProof0, null);
      assert.notEqual(targetProof1, null);
      if (targetProof0 && targetProof1) {
  ...
  describe('make tree with addLeaf buffers', () => {
    const merkleTools = new MerkleTools();
  ...
  describe('make tree with addLeaf bad hex', () => {
    const merkleTools = new MerkleTools();

    it('error should be thrown', () => {
      assert.throws(() => {
        merkleTools.addLeaf('nothexandnothashed');
      }, Error);
    });
  });

  describe('make tree with 1 leaf', () => {
    const merkleTools = new MerkleTools();
    merkleTools.addLeaves([
  ...
  describe('make tree with 5 leaves', () => {
    const merkleTools = new MerkleTools();
    merkleTools.addLeaves([
      'ca978112ca1bbdcafac231b39a23dc4da786eff8147c4e72b9807785afee48bb',
  ...
  describe('make tree with 5 leaves individually needing hashing', () => {
    const merkleTools = new MerkleTools();
  ...
  describe('make tree with 5 leaves at once needing hashing', () => {
    const merkleTools = new MerkleTools();
  ...
  describe('make tree using makeBTCTree odd leaves', () => {
    const merkleTools = new MerkleTools();
    ...
    for (let x = 0; x < hashes.length; x++) {
      const h = hashes[x].match(/.{2}/g);
      assert.notEqual(h, null);
      if (h) {
        hashes[x] = h.reverse().join('');
      }
    }
    merkleTools.addLeaves(hashes);
    ...
    it('merkle root value should be correct', () => {
      ...
      assert.notEqual(merkleRoot, null);
      if (merkleRoot !== null) {
        const match = merkleRoot.toString('hex').match(/.{2}/g);
        assert.notEqual(match, null);
        if (match) {
          assert.equal(
            match.reverse().join(''),
            '7099d100635a0e5f62ef12a8420c99426a408951078f191a0f63ddedc4dcd198'
          );
        }
      }
    });
  ...
  describe('make tree using makeBTCTree one leaf', () => {
    const merkleTools = new MerkleTools();
  ...
  describe('make tree using makeBTCTree even leaves', () => {
    const merkleTools = new MerkleTools();
    ...
    it('merkle root value should be correct', () => {
      ...
      if (merkleRoot) {
        ...
        if (match) {
          assert.equal(
            match.reverse().join(''),
            'b02c190b3a4d8a32b2f053ffd6353495fb857ad03ff600002c581a3a2232f696'
          );
        }
      }
    });
  ...
  describe('make tree using md5', () => {
    const merkleTools = new MerkleTools({ hashType: 'md5' });
    ...
    it('merkle root value should be correct', () => {
      ...
      assert.notEqual(merkleRoot, null);
      if (merkleRoot) {
        assert.equal(merkleRoot.toString('hex'), mRootmd5.toString('hex'));
      }
    });
  });

  describe('proof left node', () => {
    const merkleTools = new MerkleTools();
    merkleTools.addLeaf(bLeft);
    merkleTools.addLeaf(bRight);
    merkleTools.makeTree();
    const proof = merkleTools.getProof(0);
    assert.notEqual(proof, null);
    if (proof) {
      it('proof array should be correct', () => {
        assert.equal(
          proof[0].right,
          'cb4990b9a8936bbc137ddeb6dcab4620897b099a450ecdc5f3e86ef4b3a7135c'
        );
  ...
  describe('proof right node', () => {
    const merkleTools = new MerkleTools();
    merkleTools.addLeaf(bLeft);
    merkleTools.addLeaf(bRight);
    merkleTools.makeTree();
    const proof = merkleTools.getProof(1);
    assert.notEqual(proof, null);
    if (proof) {
      it('proof array should be correct', () => {
        assert.equal(
  ...
  describe('validate bad proof 2 leaves', () => {
    const merkleTools = new MerkleTools();
    merkleTools.addLeaf(bLeft);
    merkleTools.addLeaf(bRight);
    merkleTools.makeTree();
    ...
    assert.notEqual(proof, null);
    if (proof) {
      const isValid = merkleTools.validateProof(
        proof,
        bRight,
        'a292780cc748697cb499fdcc8cb89d835609f11e502281dfe3f6690b1cc23dcb'
      );

      it('proof should be invalid', () => {
        assert.equal(isValid, false);
      });
    }
  });

  describe('validate bad proof 5 leaves', () => {
    const merkleTools = new MerkleTools();
    merkleTools.addLeaves([
      'ca978112ca1bbdcafac231b39a23dc4da786eff8147c4e72b9807785afee48bb',
      '3e23e8160039594a33894f6564e1b1348bbd7a0088d42c4acb73eeaed59c009d',
    ...
    merkleTools.makeTree();
    const proof = merkleTools.getProof(3);
    assert.notEqual(proof, null);
    if (proof) {
      const isValid = merkleTools.validateProof(
        proof,
  ...
  describe('validate good proof 5 leaves', () => {
    const merkleTools = new MerkleTools();
    merkleTools.addLeaves([
      'ca978112ca1bbdcafac231b39a23dc4da786eff8147c4e72b9807785afee48bb',
      '3e23e8160039594a33894f6564e1b1348bbd7a0088d42c4acb73eeaed59c009d',
    ...
    merkleTools.makeTree();
    const proof = merkleTools.getProof(4);
    assert.notEqual(proof, null);
    if (proof) {
      const isValid = merkleTools.validateProof(
        proof,
      ...
      it('proof should be valid', () => {
        assert.equal(isValid, true);
      });
    }
  });

  describe('validate good proof 5 leaves B', () => {
    const merkleTools = new MerkleTools();
    merkleTools.addLeaves([
      'ca978112ca1bbdcafac231b39a23dc4da786eff8147c4e72b9807785afee48bb',
      '3e23e8160039594a33894f6564e1b1348bbd7a0088d42c4acb73eeaed59c009d',
  ...
  describe('validate good proof BTC doubleHash', () => {
    const merkleTools = new MerkleTools();
    merkleTools.addLeaves([
      '1a02db5db5a24c5edc5b653051d8aaaddec3f9abc30354f7df358c49fe40f735',
      'd3f3eb471e368a27f5320ff7a961bed748519139435cf8348e84ebd6225d7150',
    ...
    if (proof) {
      const isValid = merkleTools.validateProof(
        proof,
        'd3f3eb471e368a27f5320ff7a961bed748519139435cf8348e84ebd6225d7150',
        '502606f374e3e0ec3b7022bfe6631b9a9c9f5cf6dcbe74f171ef5b14676c9ee0',
        true
      );
...
describe('Test other hash functions', () => {
  describe('make SHA224 tree with 2 leaves', () => {
    const merkleTools = new MerkleTools({ hashType: 'SHA224' });
    merkleTools.addLeaves([
    ...
    it('proof array should be correct', () => {
      const merkleProof = merkleTools.getProof(0);
      assert.notEqual(merkleProof, null);
      if (merkleProof) {
        assert.equal(
          merkleProof[0].right,
          '35f757ad7f998eb6dd3dd1cd3b5c6de97348b84a951f13de25355177'
  ...
  describe('make SHA256 tree with 2 leaves', () => {
  ...
  describe('make SHA384 tree with 2 leaves', () => {
    const merkleTools = new MerkleTools({ hashType: 'SHA384' });
    merkleTools.addLeaves([
  ...
  describe('make SHA512 tree with 2 leaves', () => {
    const merkleTools = new MerkleTools({ hashType: 'SHA512' });
    merkleTools.addLeaves([
  ...
  describe('make SHA3-224 tree with 2 leaves', () => {
    const merkleTools = new MerkleTools({ hashType: 'SHA3-224' });
    merkleTools.addLeaves([
  ...
  describe('make SHA3-256 tree with 2 leaves', () => {
    const merkleTools = new MerkleTools({ hashType: 'SHA3-256' });
    merkleTools.addLeaves([
  ...
  describe('make SHA3-384 tree with 2 leaves', () => {
    const merkleTools = new MerkleTools({ hashType: 'SHA3-384' });
    merkleTools.addLeaves([
  ...
  describe('make SHA3-512 tree with 2 leaves', () => {
    const merkleTools = new MerkleTools({ hashType: 'SHA3-512' });
    merkleTools.addLeaves([
